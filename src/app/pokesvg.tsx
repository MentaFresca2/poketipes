...
const Svgs: React.FC<SvgsProps> = ({ svg, cuantos, ids, onPulsado,onClick}) => {
  ...
  return (
    <div
      ...
      className={`rounded-full flex justify-center items-center w-[70px] h-[70px] m-[10px] z-50 bg-[#121418] border-[3px] border-solid border-black select-none animacionbrillo`}
    >
